...
-- 5 
insert into tb_pizzas(nome, preco, borda, tamanho, tb_categorias_id) values ("Calabreza", 59.99, "Catupiry", "Grande", 1); 
insert into tb_pizzas(nome, preco, borda, tamanho, tb_categorias_id) values ("Atum", 30.99, "Catupiry", "Grande", 1); 
insert into tb_pizzas(nome, preco, borda, tamanho, tb_categorias_id) values ("Queijo", 53.99, "Catupiry", "Grande", 1); 
insert into tb_pizzas(nome, preco, borda, tamanho, tb_categorias_id) values ("Margeritha", 102.99, "Catupiry", "Grande", 1); 
insert into tb_pizzas(nome, preco, borda, tamanho, tb_categorias_id) values ("Frango", 67.99, "Chocolate", "Média", 2); 
insert into tb_pizzas(nome, preco, borda, tamanho, tb_categorias_id) values ("Confete", 34.99, "Chocolate", "Grande", 2); 
insert into tb_pizzas(nome, preco, borda, tamanho, tb_categorias_id) values ("Portuguesa", 39.99, "Catupiry", "Grande", 3); 
